...
To secure the password, we will leverage on the CreateVdpPasswordFile job to create a secure encrypted password file. This way we will not have to pass the password to the script and job. For more information have a look at [**CreateVdpPasswordFilew**](https://github.com/Actifio/ActJenkins/tree/master/CreateVdpPasswordFile).
